 ...
 *
 * request url:
 * https://cat.eduroam.org/user/API.php?action=downloadInstaller&device=ANDROID_DEVICE_GROUP&profile=ID&lang=LANG
 *
 * Example for Android P (9.0):
 * https://cat.eduroam.org/user/API.php?action=downloadInstaller&device=android_8_10&profile=5042&lang=en
 */
